...
/**
 * Interface to listen for events within a file list, including clicks and updates.
 */
abstract interface FileListEventListener {
    ...
    /**
     * Called when the file list view is updated.
     *
     * @param startPosition The starting position of the update.
     * @param itemCount The number of items updated.
     */
    fun onFileListViewUpdated(startPosition: Int, itemCount: Int)    
}